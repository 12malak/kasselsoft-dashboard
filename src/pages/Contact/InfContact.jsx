...
function InfContact() {
  ...
  const handleSubmit = (id) => {
    ...
    navigate(`/${lang}/updateContact`, { state: { id } });
  };
  ...
  return (
    ...
    subtitle={lang === "ar" ? "قائمه معلومات التواصل " : "List of Contact information"}
    />
    <Box
      m="40px 0 0 0"
      height="75vh"
    ...
    >
      ...
      <DataGrid
        rows={infContact} // Ensure this is an array of objects
        columns={columns}

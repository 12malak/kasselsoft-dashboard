...
function ServicesHome() {
  ...
  useEffect(() => {
    const fetchAllData = async () => {
      try {
        const mainhomeRes = await axios.get(`${API_URL}/homeservices/${lang}`);
  ...
  return (
    <Box m="20px">
     <Header title={lang ==="ar" ? "خدمات الرئيسية" :"Services Home"} subtitle={lang === 'ar' ? "بيانات خدمات الرئيسية" :"List of services Home" }/>
